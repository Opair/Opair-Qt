...
macx {
    ...
    OPENSSL_LIB_PATH/usr/local/Cellar/openssl/1.1.0
    OPENSSL_INCLUDE_PATH=/usr/local/Cellar/openssl/1.1.0/include
    MINIUPNPC_INCLUDE_PATH=/usr/local/Cellar/
    MINIUPNPC_LIB_PATH=/usr/local/Cellar/miniupnpc
}
...
isEmpty(BDB_LIB_PATH) {
    macx:BDB_LIB_PATH = /usr/local/cellar/berkeley-db4/4.8.30
}
...
isEmpty(BOOST_LIB_PATH) {
    macx:BOOST_LIB_PATH = /usr/local/cellar/boost/1.60.0_2/lib
}

isEmpty(BOOST_INCLUDE_PATH) {
    macx:BOOST_INCLUDE_PATH = /usr/local/cellar/boost/1.60.0_2/include
}
